...
# model = TraceableQwen2_5_VLForConditionalGeneration.from_pretrained(model_id, torch_dtype="auto",).to("cuda:0")
...
SAVE_DIR =  "/ms/FM/gongoubo/checkpoints/data/Qwen3-VL-Instruct"+ "-W8A8-include-vit"
